 ...
 *   token/秒 实测(5s 文生,2026-07-14):720p=10128 / 1080p=21780 / 2k=49005;
 *   ⚠️ 4k 当时上游余额不足未测,按像素比外推 ~112000(已上取整留冗余)—— 上游充值后请重测校准!
 *
...
const SAFETY = 1.0;
const TOK_PER_SEC = { '720p': 10128, '1080p': 21780, '2k': 49005, '4k': 112000 /* 外推,待重测 */ };
