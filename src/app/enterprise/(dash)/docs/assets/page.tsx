 ...
 * (R2 + user_id 行级归属,2026-08-06 v3);2026-09-22 起火山渠道也统一走平台库(筷子私域库已停用)。
 * 静态 JSX(镜像主 docs 模式)。
 */
...
curl -X POST ${BASE}/v1/video/generations \\
  ...
  -d '{"model":"seedance-2-0","prompt":"主角在雨中行走","images":["group-…"]}'`}</Pre>
            ...
            <Section id="volc-channel-assets" title="4.5 火山渠道的素材库(2026-09-22 起与其它渠道一致)">
                <p>
                    若您使用的是<b>火山渠道</b>(<Code>doubao-seedance-*</Code> 系模型),上述 10 个 Action
                    的契约、字段、调用方式与其它渠道<b>完全一致</b>,素材同样由平台托管(2026-09-22
                    起,此前的火山私域库已停用):
                </p>
                <ul className="list-disc space-y-1 pl-5">
                    <li>
                        <b>
                            <Code>CreateAsset</Code> 同步入库,返回即 <Code>Active</Code>
                        </b>
                        —— 不再需要轮询 <Code>GetAsset</Code> 等待就绪;素材 URL 不合格(不可下载 / 尺寸不合规)会直接 400
                        并说明原因。
                    </li>
                    <li>
                        <b>素材 URL 为平台直链,长期有效</b>(不再是 12 小时过期的签名链),可以缓存。
                    </li>
                    <li>
                        <b>2026-09-22 之前在火山私域库创建的素材 / 素材组编号已失效</b>,请重新 <Code>CreateAsset</Code>
                        。此后创建的编号形如 <Code>asset-20260922143000-a1b2c3</Code> / <Code>group-…</Code>, 生成时用{' '}
                        <Code>asset://asset-…</Code> 引用,与其它渠道相同。
                    </li>
                </ul>
                <p>
                    组类型仅支持 <Code>AIGC</Code> 与 <Code>LivenessFace</Code>;<Code>SortBy</Code> /{' '}
                    <Code>SortOrder</Code> 接受但忽略。真人素材见下一节。
                </p>
            </Section>
