...
- **GroupRatio = 该组 ¥/$ 汇率直读**(new-api 分组倍率面板里的数就是那档卖多少 ¥ 换 $1)。现值:default/vip/svip 1.2、az-gpt 1.5、official-gpt 2.6、official 3.4、claude-aws-platform-t2 2.4、claude-aws-bedrock 2.7、cc-kiro 0.4、图片/视频组全部 1.2、**pool-gpt 0.2**(新组,承接原 default 里的 GPT 聊天池子,ch33/ch70;default key 调 gpt-5.x 已 503,受影响 28 客户已发 pool-gpt 档 key)。
